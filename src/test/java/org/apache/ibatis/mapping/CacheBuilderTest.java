...
class CacheBuilderTest {
  ...
  void testInitializing() {
    InitializingCache cache = unwrap(new CacheBuilder("org/apache/ibatis/debug").implementation(InitializingCache.class).build());
  ...
  void testInitializingFailure() {
    when(() -> new CacheBuilder("org/apache/ibatis/debug").implementation(InitializingFailureCache.class).build());
