...
class SQLTest {
  ...
  void selectUsingLimitVariableName() {
    final String sql = new SQL() {
      {
        SELECT("*").FROM("org/apache/ibatis/debug").ORDER_BY("id").LIMIT("#{limit}");
      }
    }.toString();
  ...
  void selectUsingOffsetVariableName() {
    final String sql = new SQL() {
      {
        SELECT("*").FROM("org/apache/ibatis/debug").ORDER_BY("id").OFFSET("#{offset}");
      }
    }.toString();
  ...
  void selectUsingLimitAndOffset() {
    final String sql = new SQL() {
      {
        SELECT("*").FROM("org/apache/ibatis/debug").ORDER_BY("id").LIMIT(20).OFFSET(100);
      }
    }.toString();
  ...
  void updateUsingLimit() {
    final String sql = new SQL() {
      {
        UPDATE("org/apache/ibatis/debug").SET("status = #{updStatus}").WHERE("status = #{status}").LIMIT(20);
      }
    }.toString();
  ...
  void deleteUsingLimit() {
    final String sql = new SQL() {
      {
        DELETE_FROM("org/apache/ibatis/debug").WHERE("status = #{status}").LIMIT(20);
      }
    }.toString();
  ...
  void selectUsingFetchFirstRowsOnlyVariableName() {
    final String sql = new SQL() {
      {
        SELECT("*").FROM("org/apache/ibatis/debug").ORDER_BY("id").FETCH_FIRST_ROWS_ONLY("#{fetchFirstRows}");
      }
    }.toString();
  ...
  void selectUsingOffsetRowsVariableName() {
    final String sql = new SQL() {
      {
        SELECT("*").FROM("org/apache/ibatis/debug").ORDER_BY("id").OFFSET_ROWS("#{offsetRows}");
      }
    }.toString();
  ...
  void selectUsingOffsetRowsAndFetchFirstRowsOnly() {
    final String sql = new SQL() {
      {
        SELECT("*").FROM("org/apache/ibatis/debug").ORDER_BY("id").OFFSET_ROWS(100).FETCH_FIRST_ROWS_ONLY(20);
      }
    }.toString();
