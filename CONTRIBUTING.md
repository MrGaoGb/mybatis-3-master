...
- The best way to report a bug is to create a failing debug case. Please see the [Contributing code](CONTRIBUTING.md#contributing-code) section.
...
For how to write a unit debug, please see the [unit debug](https://github.com/mybatis/mybatis-3/wiki/Unit-Test) page.
